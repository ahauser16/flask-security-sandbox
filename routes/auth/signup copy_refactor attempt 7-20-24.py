...
def signup_view():
    ...
    if form.validate_on_submit():
        ...
        # debug notes: get_roles_from_db() is returning an empty dictionary
        # `roles_dict looks like: {1: 'Admin', 2: 'Principal', 3: 'Traditional Notary', 4: 'Electronic Notary'}`
        roles_dict = get_roles_from_db()
        
        
        # Assuming your form has a field 'role_ids' where users select their roles
        user_chosen_role_ids = form.role_ids.data if hasattr(form, 'role_ids') else []
